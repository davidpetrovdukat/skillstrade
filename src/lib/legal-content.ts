        ...
        sections: [
            ...
            },
            {
                ...
                content: [
                    ...
                    "Freelancers are engaged under independent contractor service agreements entered into directly with Skills-Trade or through the Platform workflow.",
                    "Freelancers are not employees Skills-Trade.", 
                    "There are no employment contracts, payroll arrangements, social insurance contributions, or employer-employee relationshipsbetween Skills-Trade and any Freelancer.",
                    "Freelancers are solely responsible fortheir own tax obligations, social contributions, insurance, and regulatory compliance in their respective jurisdictions."
                ]
            },
            {
                title: "3. Eligibility",
            ...
            },
            {
                ...
                content: [
                    ...
                    "6.6 No withdrawals or cash-out. Tokens cannot be withdrawn, converted back to fiat currency, or cashed out in any form. The Platform does not process any outbound payments, payouts, or fund transfers to users. All card transactions processed through the Platform are exclusively inbound payments from Clients for the purchase of Tokens or direct service payments. There is no functionality on the Platform to withdraw funds, receive payouts, or transfer value to a bank account, card, or any external payment method."
                ]
            },
            {
                title: "7. Payments",
                content: [
                    ...
                    "7.4 Inbound payments only. The Platform processes only inbound card payments from Clients. No outbound payments, payouts, or disbursements to Freelancers, users, or any third parties are made through the Platform's card processing infrastructure. Freelancer compensation is managed separately outside the scope of the Platform's payment processing."
                ]
            },
            {
                title: "8. Refunds of Token Purchases",
                content: [
                    "8.1 Unused purchased tokens. A Client may request a refund of unused purchased tokens to the original payment method, provided that: the request is made within 14 days of the relevant purchase; and those purchased tokens have not been spent, committed to an active Order, reserved in escrow, or otherwise used. For the avoidance of doubt, refunds are only available for purchased Token packages that remain 100% unused, uncommitted, and not allocated to any Order or escrow. Partial token balances are not eligible for fiat refund.",
            ...
            },
            {
                ...
                content: [
                    "9.1 Order types. Clients may obtain services through the Platform in two ways: (a) Direct purchase — the Client pays for a specific listed service directly at checkout using a card payment, without the need to pre-purchase or hold any Tokens; or (b) Token wallet — the Client first tops up their Token balance by purchasing a Token package, and then uses Tokens from their wallet balance to order one or more services over time. Both options result in the same service delivery, quality standards, and Platform protections including escrow and dispute resolution. Clients may also submit a custom brief and proceed with an approved scope through the Platform under either payment method.",
        ...
        sections: [
            ...
            },
            {
                ...
                content: [
                    ...
                    "6.4 No cash-out. The Platform does not support withdrawal of Token balances to a bank account, card, or any external payment method outside the 14-day cooling-off refund described in Section 2. Tokens are intended exclusively for use within the Platform."
                ]
            },
            {

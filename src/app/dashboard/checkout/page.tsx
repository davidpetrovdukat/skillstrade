...
import { EXCHANGE_RATES, type CurrencyCode } from "@/store/useCurrencyStore";
...
function formatCheckoutPrice(amountInEur: number, currency: string) {
    ...
    }).format(amountInEur * EXCHANGE_RATES[safeCurrency]);
}
...
export default function CheckoutPage() {
    ...
    const selectedCurrency = normalizeCurrencyCode(checkout.currency);
                    ...
                    <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-12">
                        <div className="flex flex-col gap-6">
                            <div className="flex flex-col gap-2">
                                <h1 className="text-3xl font-bold uppercase tracking-widest font-heading">Checkout</h1>
                            ...
                            <div className="bg-[#161616] border border-white/10 p-6 flex flex-col gap-4">
                                ...
                                <div className="flex justify-between items-start gap-6">
                                    ...
                                    <p className="text-lg font-bold text-white text-right">
                                        {formatCheckoutPrice(checkout.amount, selectedCurrency)}
                                    </p>
                                </div>
                                ...
                                <div className="flex justify-between text-sm">
                                    ...
                                    <span className="font-mono">{formatCheckoutPrice(checkout.amount, selectedCurrency)}</span>
                                </div>
                                ...
                                <div className="flex justify-between items-end gap-6">
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <span className="text-[10px] uppercase tracking-[0.18em] text-gray-500">VAT included</span>
                                    </div>
                                    <span className="text-2xl font-bold font-mono text-[#D3E97A] text-right">
                                        {formatCheckoutPrice(checkout.amount, selectedCurrency)}
                                    </span>
                                </div>
                            </div>

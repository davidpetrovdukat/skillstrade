        ...
        <div className="flex min-h-screen w-full flex-col bg-background-dark text-white font-display overflow-x-hidden border-x border-white/20 max-w-[1440px] mx-auto">
            ...
            <main className="flex flex-col w-full">
                ...
                <section className="relative w-full h-[600px] bg-[#12120e] flex flex-col items-center justify-center overflow-hidden border-b border-white/10">
                    ...
                    {/* Decorative glowing nodes (European coords) */}
                    {/* Šiauliai, Lithuania (Main) */}
                    <div className="absolute top-[28%] left-[54%] size-3 bg-primary rounded-full shadow-[0_0_15px_#d0f906] animate-ping"></div>
                    <div className="absolute top-[28%] left-[54%] size-2 bg-primary rounded-full shadow-[0_0_15px_#d0f906]"></div>

                    {/* Secondary Lights (Europe) */}
                    <div className="absolute top-[32%] left-[47%] size-1.5 bg-primary rounded-full shadow-[0_0_10px_#d0f906] animate-pulse delay-75" title="London"></div>
                    <div className="absolute top-[31%] left-[51%] size-1.5 bg-primary rounded-full shadow-[0_0_10px_#d0f906] animate-pulse delay-150" title="Berlin"></div>
                    <div className="absolute top-[35%] left-[48%] size-1.5 bg-primary rounded-full shadow-[0_0_10px_#d0f906] animate-pulse delay-300" title="Paris"></div>
                    <div className="absolute top-[42%] left-[45%] size-1.5 bg-primary rounded-full shadow-[0_0_10px_#d0f906] animate-pulse delay-500" title="Madrid"></div>
                    <div className="absolute top-[40%] left-[53%] size-1.5 bg-primary rounded-full shadow-[0_0_10px_#d0f906] animate-pulse delay-200" title="Rome"></div>
                    <div className="absolute top-[30%] left-[54%] size-1.5 bg-primary rounded-full shadow-[0_0_10px_#d0f906] animate-pulse delay-100" title="Warsaw"></div>
                    <div className="absolute top-[22%] left-[53%] size-1.5 bg-primary rounded-full shadow-[0_0_10px_#d0f906] animate-pulse delay-700" title="Stockholm"></div>
                    <div className="absolute top-[31%] left-[49%] size-1.5 bg-primary rounded-full shadow-[0_0_10px_#d0f906] animate-pulse delay-400" title="Amsterdam"></div>
                    <div className="absolute top-[35%] left-[53%] size-1.5 bg-primary rounded-full shadow-[0_0_10px_#d0f906] animate-pulse delay-600" title="Vienna"></div>
                    <div className="absolute top-[37%] left-[60%] size-1.5 bg-primary rounded-full shadow-[0_0_10px_#d0f906] animate-pulse delay-300" title="Kyiv"></div>
                </section>
